...
<div class="container p-3 mt-4 mb-4 bg-light border rounded">
  ...
  <form name="form" role="form" action="./app/notaSaidaBD.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="qtdSaida" value="<?= $linha['qtd_estoque_prod']; ?>" required id="qtdSaida" onkeyup="calcular()">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="descMaterial" placeholder="Informe a descrição do produto." value="<?= $linha['nome_prod'];?>" name="descMaterial" rows="3"></textarea>
  </div>
