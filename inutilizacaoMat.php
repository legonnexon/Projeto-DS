    ...
    <form name="form" class="needs-validation justify-content-center" role="form" action="./app/inutilizacaoMatbd.php" method="POST">
      ...
      <div class="d-flex" style="gap: 16px;">
        ...
        <div class="form-group w-25">
          ...
          <input type="text" class="form-control" id="dataFab" name="dataFab" value="<?= $linha['data_fab_prod']; ?>">
        </div>

        <div class="form-group w-25">
          <label for="dataValid" class="control-loteMaterial">Data Validade:</label>
          <input type="text" class="form-control" id="dataValid" name="dataValid" value="<?= $linha['data_valid_prod']; ?>">
        </div>
      </div>
      ...
      <div class="d-flex" style="gap: 16px;">
        <div class="form-group w-50">
          ...
          <input type="text" class="form-control" id="descMaterial" name="descMaterial" value="<?= $linha['nome_prod']; ?>">
        </div>
        <div class="form-group w-25">
          <label for="idMat" class="control-label">ID. Material:</label>
          <input type="text" class="form-control" id="idMat" name="idMat" value="<?= $linha['id_produto']; ?>">
        </div>

        <div class="form-group w-25">
          <label for="idMat" class="control-loteMaterial">Lote Material:</label>
          <input type="text" class="form-control" id="loteMaterial" name="loteMaterial" value="<?= $_SESSION['idAlmoxLogin']; ?>">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="marcaMaterial" name="marcaMaterial" value="<?= $linha['marca_prod']; ?>">
      </div>

      <!-- medida -->
      <div class="form-group">
        <label for="medMaterial" class="control-loteMaterial">Medida:</label>
        <input type="text" class="form-control" id="medMaterial" name="medMaterial" value="<?= $linha['medida_prod']; ?>">
      </div>
      ...
      <div class="d-flex" style="gap: 16px;">
        ...
        <div class="form-group w-25">
          ...
          <input type="text" class="form-control" id="qtdEmEstoque" name="qtdEmEstoque" value="<?= $linha['qtd_estoque_prod']; ?>" onkeyup="calcular()">
        </div>

        <div class="form-group w-25">
          <label for="vlUnit" class="control-loteMaterial">Vl. Preço Médio:</label>
          <input type="text" class="form-control" id="vlUnit" name="vlUnit" value="<?= $linha['vl_preco_med_prod']; ?>" onkeyup="calcular()">
        </div>
