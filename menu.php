<nav id="navBar" class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="sgv.php"><img src="./img/usuarioMenu.jpeg"   class=" " alt="..." style="max-height:60; border: none;"><span class="display-5">  <span class="h6 text-muted">Sistema Gerenciador de Materiais - <?=$_SESSION["nivel"];?></span></a>
